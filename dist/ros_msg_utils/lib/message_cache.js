...
exports.packageMap = exports.Find = exports.MESSAGE_PATH = exports.CMAKE_PATHS = exports.CMAKE_PREFIX_PATH = void 0;
const fs = require("fs");
const path = require("path");
exports.CMAKE_PREFIX_PATH = process.env.CMAKE_PREFIX_PATH;
if (!exports.CMAKE_PREFIX_PATH) {
    throw new Error('Unable to find CMAKE_PREFIX_PATH environment variable. Did you source setup.bash?');
}
exports.CMAKE_PATHS = exports.CMAKE_PREFIX_PATH.split(path.delimiter);
exports.MESSAGE_PATH = path.join('share', 'gennodejs', 'ros');
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
const packagePaths = {};
exports.CMAKE_PATHS.forEach((cmakePath) => {
    const dirPath = path.join(cmakePath, exports.MESSAGE_PATH);
    try {
...
exports.Find = Find;
exports.packageMap = Object.assign({}, packagePaths);
//# sourceMappingURL=message_cache.js.map