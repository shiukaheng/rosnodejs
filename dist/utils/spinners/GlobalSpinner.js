...
const ClientQueue_1 = require("./ClientQueue");
/**
 * @class GlobalSpinner
 ...
 */
class GlobalSpinner extends events_1.EventEmitter {
    constructor(options = { emit: false }) {
        super();
    ...
    addClient(client, clientId, queueSize, throttleMs) {
        if (this._queueLocked) {
            ...
            this._clientQueueMap.set(clientId, new ClientQueue_1.default(client, queueSize, throttleMs));
        }
    }
    /**
...
var LockedOp;
(function (LockedOp) {
    LockedOp[LockedOp["PING"] = 0] = "PING";
    LockedOp[LockedOp["DELETE"] = 1] = "DELETE";
    LockedOp[LockedOp["ADD"] = 2] = "ADD";
})(LockedOp || (LockedOp = {}));
;
//# sourceMappingURL=GlobalSpinner.js.map