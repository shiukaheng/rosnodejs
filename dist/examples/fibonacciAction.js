...
rosnodejs.initNode('fibonacci')
    ...
    ac.waitForServer()
        ...
        const goal = { order: 20 };
        ac.sendGoal(goal, function (result) { rosnodejs.log.info('Result: %j', result); }, function () { console.log('ACTIVE'); }, function (feedback) { rosnodejs.log.info('%j', feedback); });
...
//# sourceMappingURL=fibonacciAction.js.map